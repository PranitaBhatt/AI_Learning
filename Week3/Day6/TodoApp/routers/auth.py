...
from fastapi.security import OAuth2PasswordRequestForm  #it is an inbuilt request form having inbuilt portal in swagger which we will use as dependency injection in our endpoints
